...
import OrderingFromOrderRestaurantWarningModal from "./modals/OrderingFromOrderRestaurantWarningtModal";
...
export default function Modal() {
    ...
    return <div
        ...
        {props.type === "ordering-from-other-restaurant-warning" &&
            <OrderingFromOrderRestaurantWarningModal item={props.data}/>}
    </div>
}